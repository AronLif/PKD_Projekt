module PrintPrice
    where
        ...
        {-firstTitle
        Used as a string in the csv file to show what the column means
        -}
        firstTitle = "modell"
        ...
        {-  outputToFile search tuple1 tuple2
            outputToFile creates a CSV file with the name of the search variable and then it appends the data from
            tuple1 and tuple2 after they have been formated with hepler functions
            PRE:            True
            SIDE EFFECTS:   Creates a CSV file
            EXAMPLES:       outputToFile "RTX 3070" ("Inett",[("RTX3070","2000")]) ("Webb",[("RTX 3070","2500")])
                            creates a CSV file
        -} 
